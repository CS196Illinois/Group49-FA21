...
combined.lm<-lm(NDSI ~ Forest.Cover.Loss.in.Alaska..Square.Meters. + Snowfall..mm. + Green.House.Gas.Emissions.Per.Capita + Surface.Temperature..C., data = combinedData)
summary(combined.lm)